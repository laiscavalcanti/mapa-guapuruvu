export const linkania = [
  ...
  },
  {
    ...
    description:
      'Matéria que esclarece sobre a disputa de espaço e insumos das platas',
    label: 'Leia mais',
    url:
      'https://www.climatempo.com.br/noticia/2020/12/11/artigo-sobre-competicao-subterranea-de-plantas-e-capa-da-science-6973',
    image: './img/nytimes.png',
    alt: ''
  },
  {
    title:
      'Variabilidade genética, morfométrica e germinativa em populações de guapuruvu',
  ...
  },
  {
    ...
    description:
      'Matéria New York times sobre fungos e comunicação subterrânea das árvores',
    label: 'Leia mais',
    url:
